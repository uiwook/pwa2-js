...
// const selectorTitle = document.querySelector('.test');
const selectorTitle = document.querySelector('h1');
...
document.body.removeChild(document.querySelector('body :nth-child(5)'));